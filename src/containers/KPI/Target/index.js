...
const listKPI = [
    { no:1, name:"Triển khai công việc trong phạm vi được phân công, đảm bảo thực hiện đầy đủ, đúng tiến độ và đạt hiệu quả/kết quả theo yêu cầu" },
    { no:2, name:"Tham gia đầy đủ các khóa đào tạo, huấn luyện theo yêu cầu" },
    { no:3, name:"Nắm thật chắc các kiến thức chuyên môn của vị trí mình đảm nhận. Thường xuyên tự học hỏi để nâng cao trình độ chuyên môn." },
    { no:4, name:"Kết nối với các bộ phận liên quan để xử lý các vấn đề phát sinh một cách kịp thời" },
    { no:5, name:"Tuân thủ các quy định, quy chế, nội quy của tập đoàn và công ty" },
    { no:6, name:"Chủ động báo cáo kịp thời các trường hợp khẩn cấp, sai sót (nếu có) để xử lý, giải quyết kịp thời" },
    { no:7, name:"Thực hiện báo cáo định kỳ hoặc đột xuất theo yêu cầu của Lãnh đạo." },
    { no:8, name:"Đảm bảo cảnh quan và mỹ quan, vệ sinh nơi làm việc" }    
  ];
...
function Target(props) {
  ...
  if (listTTTD) {   
     tableTTTD = <table className="table table-bordered" id="dataTable" width="100%" cellSpacing="0">    
      <thead>
        <tr>                
          <th className="text-success h6 small font-weight-bold">STT</th>
          <th className="text-success h6 small font-weight-bold">Hạng mục đánh giá</th>
          <th className="text-success h6 small font-weight-bold">Tỷ trọng</th>
        </tr>
      </thead>
      <tbody>
        {
