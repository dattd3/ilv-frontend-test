...
class LeaveOfAbsenceDetailComponent extends React.Component {
  ...
  checkAuthorize = async () => {
    ...
    const dateToCheck = data.contractType == 'VA' ? (checkIsExactPnL(Constants.pnlVCode.VinSchool, Constants.pnlVCode.VinHome, Constants.pnlVCode.Vin3S) ? -75 : -45) : -7; 
  ...
  verifyInputs = () => {
    ...
    if(type === 'request'){
      ...
      if(checkIsExactPnL(Constants.pnlVCode.VinSchool, Constants.pnlVCode.VinHome, Constants.pnlVCode.Vin3S)) {
      ...
      if(this.state.isNguoidanhgia == false || checkIsExactPnL(Constants.pnlVCode.VinSchool, Constants.pnlVCode.VinHome, Constants.pnlVCode.Vin3S)) {
...
renderEvalution = (name, data, isDisable) => {
  ...
  if(checkIsExactPnL(Constants.PnLCODE.VinSchool, Constants.pnlVCode.VinHome, Constants.pnlVCode.Vin3S)) {
  ...
  render() {
    ...
    return (
      ...
      <div className="leave-of-absence evalution">
        ...
        {
          //checkIsExactPnL(Constants.PnLCODE.VinSchool, Constants.pnlVCode.VinHome, Constants.pnlVCode.Vin3S) ?
          false ?
          null :
        <>
