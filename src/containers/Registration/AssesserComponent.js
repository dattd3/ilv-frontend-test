...
class AssesserComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    if (this.props.appraiser) {
      this.setState({ appraiser: this.props.appraiser })
    }
  }
      ...
      <div className="box shadow">
        <div className="row">
          ...
          <div className="col-12 col-xl-4">
            ...
            <div>
              <input type="text" className="form-control" value={this.state.appraiser ? this.state.appraiser.department : ""} readOnly />
            </div>
          </div>
        </div>
        {
