    ...
    <div ref={innerRef} {...innerProps} className="approver" style={{ padding: '2px 0', fontSize: 13 }}>
      <div className="d-block clearfix">
        ...
        <div className="float-left text-wrap w-75">
          {isShowRecentManagerLabel && <div className="title font-weight-bold text-dark" style={{ marginBottom: 4 }}>{t('ApproverRecently')}</div>}
  ...
  async componentDidMount() {
    ...
    if (isEdit) {
      return this.setState({
        approver: {
          ...approver,
          label: approver?.fullname || approver?.fullName,
