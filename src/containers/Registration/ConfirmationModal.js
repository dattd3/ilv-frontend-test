...
class ConfirmationModal extends React.Component {
    ...
    getHostByRequestTypeId = (dataToSap) => {
        ...
        return !!requestTypeId && [12, 14, 15, Constants.INSURANCE_SOCIAL, Constants.INSURANCE_SOCIAL_INFO, Constants.SOCIAL_SUPPORT, Constants.TAX_FINALIZATION].includes(requestTypeId)
