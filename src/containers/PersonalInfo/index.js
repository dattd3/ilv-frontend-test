...
import WorkOutSideGroup from './WorkOutSideGroup';
...
class MyComponent extends React.Component {
  ...
  render() {   
    ...
    const isEnableWorkOutsideGroup = currentCompanyCode === Constants.pnlVCode.VinES || currentCompanyCode === Constants.pnlVCode.VinHoliday1
