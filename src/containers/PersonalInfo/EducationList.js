    ...
    return (
        <div>
            <Row className="info-label">
                <Col xs={12} md={6} lg={3} className="font-weight-bold" style={{ marginBottom: 15 }}>{t("SchoolName")}</Col>
                <Col xs={12} md={6} lg={3} className="font-weight-bold" style={{ marginBottom: 15 }}>{t("TypeOfDegree")}</Col>
                <Col xs={12} md={6} lg={3} className="font-weight-bold" style={{ marginBottom: 15 }}>{t("Major")}</Col>
                <Col xs={12} md={6} lg={3} className="font-weight-bold" style={{ marginBottom: 15 }}>{t("Cohort")}</Col>
            </Row>
            {
