...
class EvaluationComponent extends React.Component {
  ...
  STATUS_OPTIONS = [
    ...
    {value: 10, label: checkIsExactPnL(Constants.PnLCODE.VinSchool, Constants.pnlVCode.VinHome, Constants.pnlVCode.Vin3S) ? 'QLTT đánh giá' : 'Người đánh giá'},
    {value: 11, label: checkIsExactPnL(Constants.PnLCODE.VinSchool, Constants.pnlVCode.VinHome, Constants.pnlVCode.Vin3S)  ? 'CBLĐ thẩm định' : 'QLTT đánh giá' },
