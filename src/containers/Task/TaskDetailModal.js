            ...
            >
                ...
                <Modal.Body>
                    <div className="registration-section">
                        ...
                        {this.state.data && this.state.data.requestTypeId === Constants.LEAVE_OF_ABSENCE ? <LeaveOfAbsenceDetailComponent action={this.props.action} leaveOfAbsence={this.state.data} viewPopup={true} /> : null}
                        {this.state.data && this.state.data.requestTypeId === Constants.BUSINESS_TRIP ? <BusinessTripDetailComponent action={this.props.action} businessTrip={this.state.data} viewPopup={true} /> : null}
