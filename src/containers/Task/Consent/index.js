...
class ConsentComponent extends React.Component {
  ...
  render() {
    ...
    let statusFiler = [
      ...
      { value: Constants.STATUS_OB_SUPERVISOR_EVALUATION , label: checkIsExactPnL(Constants.PnLCODE.VinSchool, Constants.pnlVCode.VinHome)  ? 'CBLD thẩm định' : 'QLTT đánh giá' },
