...
class ConsentComponent extends React.Component {
  ...
  render() {
    ...
    let statusFiler = [
      ...
      { value: Constants.STATUS_OB_APPRAISER_EVALUATION , label:  checkIsExactPnL(Constants.PnLCODE.VinSchool, Constants.pnlVCode.VinHome, Constants.pnlVCode.Vin3S) ? 'QLTT đánh giá' : 'Người đánh giá'},
      { value: Constants.STATUS_OB_SUPERVISOR_EVALUATION , label: checkIsExactPnL(Constants.PnLCODE.VinSchool, Constants.pnlVCode.VinHome, Constants.pnlVCode.Vin3S)  ? 'CBLĐ thẩm định' : 'QLTT đánh giá' },
