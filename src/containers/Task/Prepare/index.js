...
class RequestComponent extends React.Component {
  ...
  fetchCandidateData = params => {
    ...
    const SupportEndpoint = `${process.env.REACT_APP_REQUEST_URL}api/managementPoints/listPreparingOnboardCandidate`;
  ...
  handleSubmit = e => {
    ...
    axios.post(`${process.env.REACT_APP_REQUEST_URL}api/managementPoints`, result, config)
    .then( response => {
