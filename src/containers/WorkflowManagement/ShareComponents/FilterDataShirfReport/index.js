...
class FilterDataShirfReport extends React.Component {
  ...
  dowload() {
    ...
    this.props.clickDownload(this.state.startDate, this.state.endDate, this.state.checkedMemberIds, checkedMemberUsernames);
  }
          ...
          <div className="row">
            ...
            {this.state.reportType === Constants.TYPE_REPORT.DETAIL_REPORT &&
              <div className="col-lg-4 pb-1">
                ...
                <div className="content input-container d-flex" onClick={this.onShowMembers}>
                  <div className="box-input2 d-flex justify-content-between" data-toggle="tooltip" data-placement="top" title={this.state.selectedMembers.map(u => u.fullname).toString()}>
                    {this.state.selectedMembers.length > 0 ? trimString(this.state.selectedMembers.map(u => u.fullname).toString(), 18, '...') : <span style={{ fontSize: "14px" }}>{t("staff_selection_label")}</span>}
                  </div>
              ...
              </div>}
            {
              ...
              this.props.useDateFilter === false ? null :
                <>
                  <div className="col-lg-2">
                    <div className="title">{t("StartDate")}</div>
                  ...
                  <div className="col-lg-2">
                    <div className="title">{t("EndDate")}</div>
                    <div className="content input-container">
                      <label>
                        <DatePicker
                          name="endDate"
