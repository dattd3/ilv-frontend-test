    ...
    return (
        ...
        <div className="row align-items-center white-background">
          ...
          <div className="col-sm-6 col-md-6 col-lg-6 m-0">
            ...
            <div>Hạn hoàn thành: {this.props.target_date ? this.props.target_date : 'N/A'} </div>
          </div>
          <div className="col-sm-3 col-md-3 col-lg-3 text-center">
            <CourseStatus status = {this.props.status} />
          </div>
            <div className="col-sm-2 col-md-2 col-lg-2 text-center">            <Link to={map.RoadmapDetails + "/" + this.props.id} className ="red-button">Xem chi tiết</Link>
          </div>
        </div>
      </div>
    );
