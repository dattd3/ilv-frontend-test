      ...
      <div>
        <div className="white-body">
            <div className="row table-title">
                ...
                <h6 className="col-sm-4 col-md-4 col-lg-4 padding-right-50 m-0 font-weight-500 text-uppercase text-color-vp">HOÀN THÀNH {courseList.completed}/{courseList.courses.length}</h6>
            </div>
            <div>
